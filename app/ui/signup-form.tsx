...
export default function Form() {
    ...
    const [formState, action] = useActionState(signUp, {
        errors: {},
    });

    // Rendering the sign-up form
    return (
        <div className="space-y-3 items-center md:w-[32rem]">
            <section className="text-center mb-10">
                <h1 className={`${title_font.className} text-4xl mb-2`}>Sign Up</h1>
                <p>Igniter, sign-up with your registered account</p>
            </section>
            <form action={action}>
                <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-4">
                    ...
                    <div className='mt-4 text-center'>
                        ...
                        <Link className='underline' href='/signin'>Login</Link>
                    </div>
                </div>
            </form>
        </div>
